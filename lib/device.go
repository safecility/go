...
// CompanyUID and LocationUID are a basic organizational elements
//
// so for example:
//
...
// assumed pipelines will add additional structural processing either by extending their Device representation
type Listing struct {
